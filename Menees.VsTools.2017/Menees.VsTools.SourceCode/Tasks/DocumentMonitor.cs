namespace Menees.VsTools.Tasks
{
	...
	internal sealed class DocumentMonitor : IDisposable, IVsRunningDocTableEvents, IVsRunningDocTableEvents2
	{
		...
		private RunningDocumentTable docTable;
		private IVsRunningDocumentTable4 docTable4;
		...
		private HashSet<ITextDocument> attachedDocuments = new HashSet<ITextDocument>();
		private Dictionary<string, DocumentItem> changedDocuments = new Dictionary<string, DocumentItem>(StringComparer.OrdinalIgnoreCase);
